...
class VGG_with_ATT(nn.Module):
    def __init__(self):
        super(VGG_with_ATT, self).__init__()
        # self.mode = mode
        self.pre_layer = nn.Conv2d(in_channels=1, out_channels=3, kernel_size=3, stride=1)
        ...
        self.fc2 = nn.Linear(256 + 512 + 512, 7)
